...
void addConnection(ENetHost *server, ENetEvent &event, WorldSaver &worldSaver)
{
...

	{
		...
		c.playerData.inventory.items[10] = Item(BlockTypes::cobblestone, 64);
		c.playerData.inventory.items[11] = Item(BlockTypes::gravel, 64);
		c.playerData.inventory.items[12] = Item(BlockTypes::sand, 64);
		...
		c.playerData.inventory.items[14] = Item(BlockTypes::ice, 64);
		c.playerData.inventory.items[15] = Item(BlockTypes::bricks, 64);
		c.playerData.inventory.items[16] = Item(BlockTypes::mud_bricks, 64);
